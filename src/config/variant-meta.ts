...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  mena: {
    title: 'MENA Monitor - Real-Time Iran-Israel Conflict Intelligence',
    description: 'Real-time MENA conflict intelligence dashboard — neutral two-sided news, AI fact-checking, military tracking, damage scoring. Forked from World Monitor.',
    keywords: 'MENA, Iran, Israel, conflict monitor, war tracker, military intelligence, fact check, neutral news, Middle East, Hormuz, missiles, OSINT',
    url: 'https://menamonitor.vercel.app/',
    siteName: 'MENA Monitor',
    shortName: 'MENAMonitor',
    subject: 'Iran-Israel Conflict Intelligence and MENA Situation Awareness',
    classification: 'Conflict Monitor, OSINT Dashboard, News Aggregator',
    categories: ['news', 'intelligence'],
    features: [
      'Two-sided news (Iran vs Israel)',
      'AI fact-checking',
      'Conflict damage scorecard',
      'Missile & strike tracking',
      'Military flight monitoring',
      'Ship tracking (Strait of Hormuz)',
      'Alliance tracker',
      'Country instability index',
      'Breaking news alerts',
      'Israel rocket sirens',
