...
export class PanelLayoutManager implements AppModule {
    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        <div class="header-right">
          ${this.ctx.isDesktopApp || SITE_VARIANT === 'mena' ? '' : `<div class="download-wrapper" id="downloadWrapper">
  ...
  private createPanels(): void {
    ...
    this.ctx.map = new MapContainer(mapContainer, {
      ...
      pan: { x: 0, y: 0 },
      view: SITE_VARIANT === 'mena' ? 'mena' : (this.ctx.isMobile ? this.ctx.resolvedLocation : 'global'),
